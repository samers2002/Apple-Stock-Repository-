...
# Reproducibility 
To be able to reproduce the data follow the two Python files in the Python file. They are step by step walkthroughs on how to import any csv file and then be able to filter it. If you want to use the same csv used in this repository [here](https://www.kaggle.com/datasets/aayushmishra1512/faang-complete-stock-data) is where to get it from 
